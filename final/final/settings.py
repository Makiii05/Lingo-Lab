...
import os
MEDIA_URL = '/media/'
# This tells Django to look for a physical folder named 'media' 
# in your project's root directory (where manage.py is).
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')

# Authentication settings (already defined in your file, just a reminder)
AUTH_USER_MODEL = 'Lingolab.User'
